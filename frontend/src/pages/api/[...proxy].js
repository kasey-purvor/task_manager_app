...
export default async function handler(req, res) {
    ...
    const proxy = createProxyMiddleware({   
        ...
        //     console.log(cookies)
        //     const jwt = await cookies.get("auth-token");
        //     console.log("have i got the http-cookies from the req?", jwt);
        //     proxyReq.setHeader("auth-token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NDc5YjZjMzg0NTUwM2NmNDE0OGVkMDEiLCJpYXQiOjE2ODU5NjYwNzF9.0FQ09fYPyZUUIlD-MaJvN29XkYquXhMKgV6HjqJQuqw");
